...
if(isset($_POST['submit'])&&!empty($_POST['submit']))
{
    ...
    }else
    {
        ...
        $sql="INSERT INTO `student_table`(`name`, `gender`, `class`, `address`, `mobile_no`, `email`) VALUES ('$name','$gender','$class','$address','$mobile_number','$email')";
...
<head>
    ...
    <section class="menu-section">
        ...
        <section class="add_new_section">
            ...
            <div class="form_div">
                <form name="stu_form" action="add_new_student.php" method="post">
                    <div class="f_div">
                        <div class="label">Full Name</div>
                        <div class="field"><input type="text" name="name" class="input-field" value=""/></div>
                    </div>
                    <div class="f_div">
                    ...
                    <div class="f_div">
                        ...
                        <div class="field"><input type="text" name="class" class="input-field" value=""/></div>
                    </div>
                    <div class="f_div">
                    ...
                    <div class="f_div">
                        ...
                        <div class="field"><input type="text" name="mobile_number" class="input-field" value=""/></div>
                    </div>
                    <div class="f_div">
                        <div class="label">Email</div>
                        <div class="field"><input type="text" name="email" class="input-field" value=""/></div>
                    </div>
